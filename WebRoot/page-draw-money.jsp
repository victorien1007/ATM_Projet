...
<body>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Drawing Money</h3>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form">
                                    <div class="form-group">
                                        <label for="drawinput" class="col-sm-2 control-label">取款金额</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="drawinput" style="width:300px" placeholder="please input you drawing number">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button id="draw_btn" type="submit" class="btn btn-primary">Submit</button>
                                        </div>
                                    </div>
                                </form>
    ...
    $("#draw_btn").click(function() {
    	    ...
    	    var id = "${userId}";
            var drawnum = $("#drawinput").val();
            var requestURL = "atm/withdraw/"+id+"/"+drawnum;
            $.ajax({
                type : "GET",
                url : requestURL,
                async : false,
